 ...
 *
 */
public class CreateTablesTag
    extends ExecuteSqlsTagBase
{
    /**
     * Override method getSqls in class CreateTablesTag
     *
        ...
        throws Exception
    {
        ...
        return hibernate.getHibernateConfiguration().generateSchemaCreationScript( dialect );
    }
}
