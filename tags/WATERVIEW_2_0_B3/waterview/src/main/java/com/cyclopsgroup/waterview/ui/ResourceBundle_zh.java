...
public class ResourceBundle_zh extends ListResourceBundle
{
    private static final Object[][] CONTENTS = {
            ...
            { "waterview.view.setlookandfeel", "设置系统外观" },
            ...
            { "document.text.pushme", "点这里" }, { "document.text.id", "编号" },
            { "document.text.name", "名称" }, { "document.text.title", "标题" },
            ...
            { "document.text.type", "类型" }, { "document.text.record", "记录" },
            { "document.text.edit", "编辑" }, { "document.text.row", "行" },
            { "document.text.configure", "配置" },
            { "document.text.info", "信息" }, { "document.text.reload", "重新载入" },
            { "document.text.page", "页" }, { "document.text.system", "系统" },
            { "document.text.true", "是" }, { "document.text.false", "否" },
            { "document.text.any", "任何" }, { "document.text.time", "时间" },
            { "document.text.date", "日期" }, { "document.text.search", "搜索" },
