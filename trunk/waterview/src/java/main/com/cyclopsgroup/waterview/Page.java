 ...
 * 
 * Licensed under the Open Software License, Version 2.1 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of the License at
 * 
...
public interface Page
{
     ...
     */
    void prepare(UIRuntime runtime, Context outputContext) throws Exception;
}