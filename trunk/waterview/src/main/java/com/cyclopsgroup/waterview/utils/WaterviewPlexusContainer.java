    ...
    extends DefaultPlexusContainer
{
     ...
     * @throws PlexusConfigurationException Throw it out
     * @throws ConfigurationResourceNotFoundException Throw it out
     * @throws ConfigurationProcessingException Throw it out
     *
                ...
                try
                {
                    ...
                    for ( Iterator i = componentConfigurationFiles.iterator(); i.hasNext(); )
                    {
                        ...
                        PlexusConfiguration componentConfiguration = PlexusTools
                            .buildConfiguration(
                                                 componentConfigurationFile.getName(),
                                                 getInterpolationConfigurationReader( new FileReader(
