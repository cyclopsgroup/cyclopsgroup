    ...
    extends HttpServlet
{
        ...
        throws Exception
    {
        ...
        data = new ServletRunData( request, response, servletConfig.getServletContext(), fileUpload, serviceManager,
                                   applicationBase );
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            String descriptor = initProperties.getProperty( "plexus.descriptor", null );
            if ( StringUtils.isNotEmpty( descriptor ) )
            {
                String descriptorPath = config.getServletContext().getRealPath( descriptor );
