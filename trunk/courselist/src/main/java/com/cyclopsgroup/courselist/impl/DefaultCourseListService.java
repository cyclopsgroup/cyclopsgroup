 ...
 */
public class DefaultCourseListService extends AbstractHibernateEnabled
        implements CourseListService
{
            ...
            throws Exception
    {
        ...
        criteria.add(Expression.eq("courseId", courseId)).add(
                Expression.eq("prerequisiteId", prereqId));
    ...
    public Course findByCode(String prefix, String code) throws Exception
    {
        ...
        criteria.add(Expression.eq("prefix", prefix)).add(
                Expression.eq("courseCode", code)).add(
                Expression.eq("isDisabled", Boolean.FALSE));
     ...
     */
    public List getAllTeachers() throws Exception
    {
