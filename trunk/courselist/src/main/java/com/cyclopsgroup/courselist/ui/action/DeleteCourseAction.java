 ...
 */
public class DeleteCourseAction extends BaseServiceable implements Action
{
    /**
            ...
            throws Exception
    {
        ...
        String[] courseNumbers = data.getParams().getStrings("course_number");
        for (int i = 0; i < courseNumbers.length; i++)
        {
            String number = courseNumbers[i];
            cpm.delete(number);
        }
    }
}
