...
public class StateMachine extends SimpleLogEnabled
{
	...
	private SimpleContext initialContext = new SimpleContext(null);
	 ...
	 */
	public SimpleContext getInitialContext()
	{
	...
	public void receiveMessage(Object message)
	{
		...
		for (int i = 0; i < transitions.length; i++)
		{
			...
			if (messageType != null && messageType.accept(message))
			{
				...
				{
					SimpleContext ctx = new SimpleContext(getInitialContext());
