    ...
    extends BasePeer
{
    ...
    public static final String TABLE_NAME = "c_tnd_groups";
    ...
    static
    {
          ...
          if (Torque.isInit())
        {
            try
            {
                getMapBuilder(GroupMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
     ...
     */
    public static Group retrieveByPK(int pk)
