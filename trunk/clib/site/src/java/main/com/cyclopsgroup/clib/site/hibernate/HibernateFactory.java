...
public interface HibernateFactory
{
    ...
    /**
     * Register a persistent entity
     *
     * @param persistenceEntity Entity class to register
     */
    void registerPersistence(Class persistenceEntity);

    /**
     * Register an HBM definition resource
     *
     * @param hbmResource HBM xml resource
     */
    void registerPersistence(URL hbmResource);
}
