    ...
    extends BasePeer
{
    ...
    public static final String TABLE_NAME = "cg_levistone_user";
    ...
    static
    {
          USER_ID = "cg_levistone_user.USER_ID";
          USER_NAME = "cg_levistone_user.USER_NAME";
          EMAIL = "cg_levistone_user.EMAIL";
          BIRTHDAY = "cg_levistone_user.BIRTHDAY";
          DESCRIPTION = "cg_levistone_user.DESCRIPTION";
          if (Torque.isInit())
        {
            try
            {
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.cyclopsgroup.levistone.torque.User";
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(BIRTHDAY);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asLong());
                  ...
                  obj.setEmail(row.getValue(offset + 2).asString());
                  obj.setBirthday(row.getValue(offset + 3).asUtilDate());
