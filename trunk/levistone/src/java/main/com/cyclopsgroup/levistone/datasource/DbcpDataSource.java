        ...
        Configurable, Initializable
{
    ...
    private Properties dbcpProperties = new Properties();
    ...
    {
        Configuration[] props = conf.getChildren("property");
        for (int i = 0; i < props.length; i++)
        {
            Configuration prop = props[i];
            String name = prop.getAttribute("name");
            String value = prop.getValue();
            dbcpProperties.setProperty(name, value);
        }
    }
