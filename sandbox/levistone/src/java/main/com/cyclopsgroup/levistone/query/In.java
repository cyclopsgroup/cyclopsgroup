...
public class In extends Comparison
{
     ...
     */
    public In(Field field, Object value)
    {
        super(field, value, Comparator.IN);
    ...
    {
        super(fieldName, value, Comparator.IN);
        checkCollection(value);
    }
     ...
     * @param value Comparison value
     */
    public In(String fieldName, String alias, Object value)
    {
        super(fieldName, alias, value, Comparator.IN);
        checkCollection(value);
    }
