...
INSERT INTO c_tnd_acls (acl_id,owner_type,owner_name,is_role,permission)
    VALUES (33,'R','basic',0,'screen:health,Index.vm');

INSERT INTO c_tnd_acls (acl_id,owner_type,owner_name,is_role,permission)
    VALUES (34,'R','basic',0,'screen:health,pub,*.vm');
...
INSERT INTO c_tnd_confs (conf_id,conf_key,conf_value)
    VALUES (11,'services.UserService.user.implementation','com.cyclops.tornado.User');
...
INSERT INTO c_tnd_confs (conf_id,conf_key,conf_value)
    VALUES (21,'services.NavigatorService.loader','resource');

INSERT INTO c_tnd_confs (conf_id,conf_key,conf_value)
    VALUES (22,'services.NavigatorService.loader.resource.classname','com.cyclops.tornado.services.navigator.FolderNavigatorLoader');

INSERT INTO c_tnd_confs (conf_id,conf_key,conf_value)
    VALUES (23,'services.NavigatorService.loader.resource.folder','WEB-INF/conf/navigator');
